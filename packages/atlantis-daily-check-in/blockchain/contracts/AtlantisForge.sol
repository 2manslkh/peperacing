...
contract AtlantisForge is IERC1155Receiver, Ownable {
    ...
    constructor(
        address _forgeToken,
        address _gemstoneContract,
        address _equipmentContract,
        uint256 _forgeAmount,
        uint256 _gemstoneAmount
    ) {
    ...
    function setEquipmentRequirement(
    ...
    function _mintEquipment(uint256 _equipmentId) internal {
        ...
        gemstoneContract.safeTransferFrom(
            msg.sender,
            address(this),
            uint256(requirement.gemstone) + 1,
            requirement.gemstoneAmount,
            "0x00"
        );
    ...
    function mintEquipmentBatch(uint256[] calldata _equipmentIds) external {
